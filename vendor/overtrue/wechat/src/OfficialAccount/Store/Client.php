...
class Client extends BaseClient
{
    ...
    {
        return $this->httpGet('wxa/get_company_category');
    }
    ...
    {
        return $this->httpPostJson('wxa/get_company_audit_info');
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|\EasyWeChat\Kernel\Support\Collection|array|object|string
     */
    public function createcompany(array $baseInfo)
    {
        return $this->httpPostJson('wxa/apply_company', $baseInfo);
    }
    ...
    {
        return $this->httpPostJson('wxa/modify_company', $params);
    }
