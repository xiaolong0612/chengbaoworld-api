...
use app\common\dao\article\guide\OperateCateDao;

/**
 * Class OperateCateRepository
 * @package app\common\repositories\article\news
 * @mixin OperateCateDao
 */
class OperateCateRepository extends BaseRepository
{

    public function __construct(OperateCateDao $dao)
    {
        $this->dao = $dao;
    }
    ...
    public function getList(array $where, $page, $limit, $companyId = null)
    {
        ...
        $list = $query->page($page, $limit)
            ->field('id,name,sort,add_time,is_show')
            ->order('sort asc')
            ->select();
