...
use app\common\model\users\UsersTrackModel;

class UsersTrackDao extends BaseDao
{

    /**
     * @return UsersTrackModel
     */
    protected function getModel(): string
    {
        return UsersTrackModel::class;
    }
