...
use app\common\model\users\UsersIntegralLogModel;

class UsersIntegralLogDao extends BaseDao
{

    /**
     * @return UsersIntegralLogModel
     */
    protected function getModel(): string
    {
        return UsersIntegralLogModel::class;
    }
    ...
    {
        $query = UsersIntegralLogModel::getDB()
